...
export type StatusKey = "all" | "transit" | "pending" | "delivered" | "cancelled";
...
const STATUS_CONFIG: StatusConfig[] = [
  ...
  { key: "delivered", label: "Delivered", dot: "bg-delivered" },
...
export default function StatusPillsContainer({
  ...
  return (
    <div className="flex gap-1.5 py-2.5 flex-wrap">
